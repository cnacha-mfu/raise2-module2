...
| **7** ⭐ | ระบบรู้จักผู้ใช้และออกสู่โลก | CLAUDE.md · **CRUD ครบ** · **ล็อกอิน + กฎขั้นต่ำ** · Git งานชนกัน · **Deploy** |
| **8** 🤖 | ระบบมียามเฝ้าและมีผู้ช่วย | **Rules รายห้อง** · **Agentic AI ผ่าน OpenRouter** · Reviewer |
| **9** 🧪 | ระบบพิสูจน์ตัวเองได้ | Tester + Playwright MCP · รายงานผลการทดสอบ + **Consult รายคน** (TPQI 7001–7005) |
