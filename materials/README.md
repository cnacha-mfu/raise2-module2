...
ผู้เรียน ~40 คน ไม่มีพื้นฐาน IT · **กลุ่มละ 3–4 คน ทำโครงงานของกลุ่มเอง** · ผู้สอน 1 + TA 2
...
├── index.md                หน้า TOC ของเว็บ GitHub Pages
│
├── materials/
│   ├── shared/
...
## 📦 สื่อ 3 ชิ้นต่อสัปดาห์

| ไฟล์ | ใช้เมื่อไร | ตัวอย่างที่ใช้ |
|---|---|---|
| `wN-slides.md` → `.pptx` | Lecture เสาร์ 09:00–12:00 | 🎬 FixIt |
| `wN-demo-fixit.md` | ผู้สอนเปิดคู่กันระหว่างสาธิต | 🎬 FixIt |
| `wN-lab-leaveeasy.md` | Workshop เสาร์ 13:00–16:00 — **กลุ่มทำโครงงานตัวเอง** | 🔧 LeaveEasy เป็นเฉลยตัวอย่าง |
...
| **9** 🎤 | ระบบพิสูจน์ตัวเองได้ | Tester + Playwright MCP · **Sprint 1 Review** (TPQI 7001–7005) |
